 ...
 */
final class Version20210628133107 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(70) NOT NULL, prenom VARCHAR(70) NOT NULL, mail VARCHAR(150) NOT NULL, adresse VARCHAR(255) NOT NULL, tel INT NOT NULL, date_debut_contrat DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE operateur (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(80) NOT NULL, adresse VARCHAR(400) DEFAULT NULL, num_siren INT NOT NULL, mail VARCHAR(300) NOT NULL, tarif DOUBLE PRECISION DEFAULT NULL, date_fin_contrat DATE DEFAULT NULL, date_debut_contrat DATE DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE consommation DROP FOREIGN KEY FK_F993F0A219EB6921');
